    ...
    <div className="space-y-6">
      <div className="bg-slate-900 p-6 rounded-[2.5rem] border border-slate-800">
        ...
        <div className="grid grid-cols-1 gap-2">
          {personal.map(p => {
            const gradMicuț = p.grad ? p.grad.toLowerCase() : "";
            ...
            const numeCompletFull = `${gradMicuț} ${prenumeFormatat} ${numeFormatat}`.trim().toUpperCase();
            ...
            return (
              <button key={p.id} onClick={() => togglePersoana(numeCompletFull)}
                ...
                <div className="text-left">
                  <p className="text-[9px] font-black text-indigo-400 leading-none mb-1">{gradMicuț}</p>
